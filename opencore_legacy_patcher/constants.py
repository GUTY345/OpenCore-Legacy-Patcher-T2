...
class Constants:
    def __init__(self) -> None:
        ...
        self.patcher_version:                 str = "4.0.0.18002"  # OpenCore-Legacy-Patcher-T2 # die richtige Version kennzeichen, damit nicht den Update-API mit unnötigen Anfragen zu überladen 
